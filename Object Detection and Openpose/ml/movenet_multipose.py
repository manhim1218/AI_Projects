...
try:
  print("Using tensorflow lite without full tensorflow package")
  # Import TFLite interpreter from tflite_runtime package if it's available.
  from tflite_runtime.interpreter import Interpreter
except ImportError:
  print("Using full tensorflow package")
...
class MoveNetMultiPose(object):
  ...
  def __init__(self,
    ...
    interpreter = Interpreter(model_path='/home/crossing/ws/src/gazebo_ros2_pepper/multipose/movenet_multipose.tflite', num_threads=4)
